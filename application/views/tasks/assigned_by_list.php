                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="tab-content no-padding">
                                ...
                                <div class="chart tab-pane active" id="due-today">
                                    <?php
                                    $this->load->view('tasks/task_table', array('id' => 'due-today-list', 'assigned_by'=>'me')); ?>
                                </div>
                                <div class="chart tab-pane" id="over-due">
                                    <?php
                                    $this->load->view('tasks/task_table', array('id' => 'over-due-list', 'assigned_by'=>'me')); ?>
                                </div>
                                <div class="chart tab-pane" id="not-due">
                                    <?php
                                    $this->load->view('tasks/task_table', array('id' => 'not-due-list', 'assigned_by'=>'me')); ?>
                                </div>
                                <div class="chart tab-pane" id="completed">
                                    <?php
                                    $this->load->view('tasks/task_table', array('id' => 'completed-list', 'assigned_by'=>'me')); ?>
                                </div>
...
<script type="text/javascript">
    ...
    function task_data_table(id) {
        return $('#' + id).dataTable({
            ...
            "ajax": {
                "url": base_url + "task/json_tasks?type=" + id + "&assigned_by=me",
            }
        });
    }
