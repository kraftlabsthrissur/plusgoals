    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form action="performanceanalysissummary/performance_summary_report" class="ajax-submit" method="POST">
                            <!-- <div class="col-xs-2">
                                <label>From Date</label>
                                <input type="text" name="from_date" readonly="readonly"
                                    class="datepicker from_date form-control"
                                    value="<?php echo isset($from_date) ? $from_date : ''; ?>" />
                            </div>
                            <div class="col-xs-2">
                                <label>To Date</label>
                                <input type="text" name="to_date" readonly="readonly"
                                    class="datepicker from_date form-control"
                        ...
                        if (isset($table_data) && is_array($table_data)) {
                           ...
                           // print_r($table_data);
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo round($row['total_rating'] / $row['total_tasks'],2); ?>
                                </td>
                            </tr>
                            <?php                   
                            }
